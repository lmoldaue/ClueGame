...
public class CR_BoardInitTests {
	...
	public static void setUp() throws FileNotFoundException {
		board = new Board("RaderFiles/RaderClueLayout.csv", "RaderFiles/RaderClueLegend.txt");
	...
	public void testBadColumns() throws BadConfigFormatException, FileNotFoundException {
		...
		Board b = new Board("RaderFiles/RaderClueLayoutBadColumns.csv", "RaderFiles/RaderClueLegend.txt");
	...
	public void testBadRoom() throws BadConfigFormatException, FileNotFoundException {
		...
		Board b = new Board("RaderFiles/RaderClueLayoutBadRoom.csv", "RaderFiles/RaderClueLegend.txt");
		b.loadRoomConfig();
		b.loadBoardConfig();
	}
	// Test that an exception is thrown for a bad config file
	...
	public void testBadRoomFormat() throws BadConfigFormatException, FileNotFoundException {
		// overloaded Board ctor takes config file name
		Board b = new Board("RaderFiles/RaderClueLayout.csv", "RaderFiles/RaderClueLegendBadFormat.txt");
		b.loadRoomConfig();
		b.loadBoardConfig();
	}
}
